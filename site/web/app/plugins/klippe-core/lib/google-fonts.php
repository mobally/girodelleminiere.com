<?php
if ( ! function_exists( 'klippe_mikado_init_google_fonts_array' ) ) {
    function klippe_mikado_init_google_fonts_array() {
        ...
        $klippe_mikado_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'klippe_mikado_init_google_fonts_array');
}