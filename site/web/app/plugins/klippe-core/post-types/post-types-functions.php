...
if ( ! function_exists( 'klippe_core_include_custom_post_types_files' ) ) {
	/**
	 * Loads all custom post types by going through all folders that are placed directly in post types folder
	 */
	function klippe_core_include_custom_post_types_files() {
	...
	add_action( 'after_setup_theme', 'klippe_core_include_custom_post_types_files', 1 );
}

if ( ! function_exists( 'klippe_core_include_custom_post_types_meta_boxes' ) ) {
	/**
	...
	add_action( 'klippe_mikado_before_meta_boxes_map', 'klippe_core_include_custom_post_types_meta_boxes' );
}

if ( ! function_exists( 'klippe_core_include_custom_post_types_global_options' ) ) {
	/**
	 ...
	 */
	function klippe_core_include_custom_post_types_global_options() {
		if ( klippe_core_theme_installed() ) {
	...
	add_action( 'klippe_mikado_before_options_map', 'klippe_core_include_custom_post_types_global_options', 1 );
}