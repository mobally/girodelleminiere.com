<?php
$gallery_classes = '';
$number_of_columns = klippe_mikado_get_meta_field_intersect('portfolio_single_gallery_columns_number');
if(!empty($number_of_columns)) {
	$gallery_classes .= ' mkdf-ps-'.$number_of_columns.'-columns';
}
$space_between_items = klippe_mikado_get_meta_field_intersect('portfolio_single_gallery_space_between_items');
...
<div class="mkdf-ps-image-holder mkdf-ps-gallery-images mkdf-disable-bottom-space <?php echo esc_attr($gallery_classes); ?>">
