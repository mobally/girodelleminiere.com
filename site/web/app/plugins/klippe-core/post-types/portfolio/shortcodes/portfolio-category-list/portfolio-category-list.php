...
namespace MikadoCore\CPT\Shortcodes\PortfolioCategoryList;
...
class PortfolioCategoryList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Mikado Portfolio Category List', 'klippe-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Items Per Page', 'klippe-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio category list. Default value is 6', 'klippe-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio category list', 'klippe-core' )
						),
						array(
							'type'       => 'dropdown',
	...
	public function render( $atts, $content = null ) {
		...
		$html = klippe_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-category-list', 'portfolio-category-holder', '', $params );
