...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Banner', 'klippe-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'klippe-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'klippe-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'klippe-core' )   => 'mkdf-visible-on-hover',
								esc_html__( 'Visible on Default', 'klippe-core' ) => 'mkdf-visible-on-default',
								esc_html__( 'Disabled', 'klippe-core' )           => 'mkdf-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'klippe-core' ),
							'value'       => array(
								esc_html__( 'Default', 'klippe-core' )  => 'default',
								esc_html__( 'Centered', 'klippe-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'klippe-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'klippe-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Subtitle Tag', 'klippe-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'klippe-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$params['img_classes']      = $this->getImageClasses( $params );

		$html = klippe_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
	...
	private function getImageClasses( $params ) {
		...
		$imgClasses[] = $params['enable_shadow'] == 'yes' ? 'shadow-enabled' : '';

		return implode( ' ', $imgClasses );
	}
