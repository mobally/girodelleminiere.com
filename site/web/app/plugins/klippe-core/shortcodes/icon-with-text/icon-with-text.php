...
class IconWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Icon With Text', 'klippe-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => array(
                                    esc_html__( 'Icon Top', 'klippe-core' )             => 'icon-top',
									esc_html__( 'Icon Left From Text', 'klippe-core' )  => 'icon-left',
									esc_html__( 'Icon Left From Title', 'klippe-core' ) => 'icon-left-from-title',
								),
								'save_always' => true
							)
						),
						...
						array(
							array(
								...
								'heading'    => esc_html__( 'Custom Icon', 'klippe-core' )
							),
							array(
								'type'       => 'dropdown',
								'param_name' => 'icon_type',
								'heading'    => esc_html__( 'Icon Type', 'klippe-core' ),
								'value'      => array(
									esc_html__( 'Normal', 'klippe-core' ) => 'mkdf-normal',
									esc_html__( 'Circle', 'klippe-core' ) => 'mkdf-circle',
									esc_html__( 'Square', 'klippe-core' ) => 'mkdf-square'
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Size', 'klippe-core' ),
								'value'      => array(
									esc_html__( 'Medium', 'klippe-core' )     => 'mkdf-icon-medium',
									esc_html__( 'Tiny', 'klippe-core' )       => 'mkdf-icon-tiny',
									esc_html__( 'Small', 'klippe-core' )      => 'mkdf-icon-small',
									esc_html__( 'Large', 'klippe-core' )      => 'mkdf-icon-large',
									esc_html__( 'Very Large', 'klippe-core' ) => 'mkdf-icon-huge'
								),
								'group'      => esc_html__( 'Icon Settings', 'klippe-core' )
							),
							array(
							...
							array(
								...
								'heading'    => esc_html__( 'Shape Size (px)', 'klippe-core' ),
								'group'      => esc_html__( 'Icon Settings', 'klippe-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Hover Color', 'klippe-core' ),
								'group'      => esc_html__( 'Icon Settings', 'klippe-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'icon_background_color',
								'heading'    => esc_html__( 'Icon Background Color', 'klippe-core' ),
								'dependency' => array(
									'element' => 'icon_type',
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Hover Background Color', 'klippe-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'mkdf-square', 'mkdf-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Border Color', 'klippe-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'mkdf-square', 'mkdf-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Border Hover Color', 'klippe-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'mkdf-square', 'mkdf-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Border Width (px)', 'klippe-core' ),
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'mkdf-square', 'mkdf-circle' )
								),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Animation', 'klippe-core' ),
							...
							array(
								...
								'heading'    => esc_html__( 'Icon Animation Delay (ms)', 'klippe-core' ),
							...
							array(
								...
								'group'       => esc_html__( 'Text Settings', 'klippe-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Title Top Margin (px)', 'klippe-core' ),
								'dependency' => array( 'element' => 'title', 'not_empty' => true ),
								'group'      => esc_html__( 'Text Settings', 'klippe-core' )
							),
							array(
							...
							array(
								...
								'description' => esc_html__( 'Set link around icon and title', 'klippe-core' )
							),
							array(
								'type'       => 'dropdown',
								'param_name' => 'target',
							...
							array(
								...
								'heading'     => esc_html__( 'Text Padding (px)', 'klippe-core' ),
								'description' => esc_html__( 'Set left or top padding dependence of type for your text holder. Default value is 13 for left type and 25 for top icon with text type', 'klippe-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return klippe_core_get_shortcode_module_template_part( 'templates/iwt', 'icon-with-text', $params['type'], $params );
	}
	...
	private function getIconParameters( $params ) {
		...
		if ( empty( $params['custom_icon'] ) ) {
			...
			if ( ! empty( $params['shape_size'] ) ) {
				$params_array['shape_size'] = klippe_mikado_filter_px( $params['shape_size'] ) . 'px';
			}
			...
			if ( $params['icon_border_width'] !== '' ) {
				$params_array['border_width'] = klippe_mikado_filter_px( $params['icon_border_width'] ) . 'px';
			}
	...
	private function getContentStyles( $params ) {
		...
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-left' ) {
			$styles[] = 'padding-left: ' . klippe_mikado_filter_px( $params['text_padding'] ) . 'px';
		}
		
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-top' ) {
			$styles[] = 'padding-top: ' . klippe_mikado_filter_px( $params['text_padding'] ) . 'px';
		}
	...
	private function getTitleStyles( $params ) {
		...
		if ( $params['title_top_margin'] !== '' ) {
			$styles[] = 'margin-top: ' . klippe_mikado_filter_px( $params['title_top_margin'] ) . 'px';
		}
