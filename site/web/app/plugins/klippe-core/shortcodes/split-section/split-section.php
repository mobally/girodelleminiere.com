...
class SplitSection implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Mikado Split Section', 'klippe-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Image Position', 'klippe-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Text Top Margin (px or %)', 'klippe-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Text', 'klippe-core' )    => 'simple'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'       => esc_html__( 'Button Style', 'klippe-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_size',
							'heading'     => esc_html__( 'Button Size', 'klippe-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link Target', 'klippe-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'klippe-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'klippe-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Hover Color', 'klippe-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'klippe-core' ),
						),
						array(
							...
							'heading'    => esc_html__( 'Button Background Color', 'klippe-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'klippe-core' ),
							'dependency' => array( 'element' => 'button_type', 'value' => array( 'solid' ) ),
							'group'      => esc_html__( 'Button Style', 'klippe-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Border Color', 'klippe-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'klippe-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Hover Border Color', 'klippe-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'klippe-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px or %)', 'klippe-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'klippe-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Responsive Breakpoint', 'klippe-core' ),
							'value'       => array(
								esc_html__( 'Never', 'klippe-core' )        => '',
							...
							'description' => esc_html__( 'Choose on which stage you want to break image and text content to be one under other', 'klippe-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = klippe_core_get_shortcode_module_template_part( 'templates/split-section', 'split-section', '', $params );
	...
	private function getTextStyles( $params ) {
		...
		if ( $params['text_top_margin'] !== '' ) {
			if ( klippe_mikado_string_ends_with( $params['text_top_margin'], '%' ) || klippe_mikado_string_ends_with( $params['text_top_margin'], 'px' ) ) {
