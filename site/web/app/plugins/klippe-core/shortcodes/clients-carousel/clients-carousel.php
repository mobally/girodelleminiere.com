...
class ClientsCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Mikado Clients Carousel', 'klippe-core' ),
					'base'            => $this->getBase(),
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'klippe-core' ),
							'value'       => array(
								esc_html__( 'Switch Images', 'klippe-core' ) => 'switch-images',
								esc_html__( 'Roll Over', 'klippe-core' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = klippe_core_get_shortcode_module_template_part( 'templates/clients-carousel', 'clients-carousel', '', $params );
