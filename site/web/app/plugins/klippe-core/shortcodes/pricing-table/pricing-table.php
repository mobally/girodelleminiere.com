...
class PricingTable implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Mikado Pricing Table', 'klippe-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'value'       => array(
								esc_html__( 'One', 'klippe-core' )   => 'mkdf-one-column',
								esc_html__( 'Two', 'klippe-core' )   => 'mkdf-two-columns',
								esc_html__( 'Three', 'klippe-core' ) => 'mkdf-three-columns',
								esc_html__( 'Four', 'klippe-core' )  => 'mkdf-four-columns',
								esc_html__( 'Five', 'klippe-core' )  => 'mkdf-five-columns',
							),
							'save_always' => true
						),
						array(
