...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Image Gallery', 'klippe-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'klippe-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'klippe-core' ) => 'grid',
								esc_html__( 'Masonry', 'klippe-core' )    => 'masonry',
								esc_html__( 'Slider', 'klippe-core' )     => 'slider',
						...
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'klippe-core' ),
							'description' => esc_html__( 'Select images from media library', 'klippe-core' )
						),
						array(
							'type'        => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'klippe-core' ),
							'value'      => array(
								esc_html__( 'None', 'klippe-core' )             => '',
								esc_html__( 'Open Lightbox', 'klippe-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'klippe-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'klippe-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'klippe-core' )        => 'grayscale'
							)
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'custom_links',
							'heading'     => esc_html__( 'Custom Links', 'klippe-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'klippe-core' ),
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Two', 'klippe-core' )   => 'two',
								esc_html__( 'Three', 'klippe-core' ) => 'three',
								esc_html__( 'Four', 'klippe-core' )  => 'four',
								esc_html__( 'Five', 'klippe-core' )  => 'five',
								esc_html__( 'Six', 'klippe-core' )   => 'six'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'klippe-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'klippe-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'klippe-core' ),
							'value'       => array_flip( klippe_mikado_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = klippe_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
