<?php
/*
Plugin Name: Klippe Twitter Feed
...
if ( ! function_exists( 'klippe_twitter_feed_text_domain' ) ) {
	/**
	 * Loads plugin text domain so it can be used in translation
	 */
	function klippe_twitter_feed_text_domain() {
		load_plugin_textdomain( 'klippe-twitter-feed', false, MIKADO_TWITTER_REL_PATH . '/languages' );
	}
	
	add_action( 'plugins_loaded', 'klippe_twitter_feed_text_domain' );
}