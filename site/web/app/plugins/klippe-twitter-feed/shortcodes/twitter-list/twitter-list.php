...
class TwitterList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Twitter List', 'klippe-twitter-feed' ),
					'base'                      => $this->base,
					'category'                  => esc_html__( 'by MIKADO', 'klippe-twitter-feed' ),
					...
					'params'                    => array(
						array(
							'type'        => 'textfield',
							'param_name'  => 'user_id',
							'heading'     => esc_html__( 'User ID', 'klippe-twitter-feed' ),
							'admin_label' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'number_of_columns',
							'heading'     => esc_html__( 'Number of Columns', 'klippe-twitter-feed' ),
							'value'       => array(
								esc_html__( 'One', 'klippe-twitter-feed' )   => '1',
								esc_html__( 'Two', 'klippe-twitter-feed' )   => '2',
								esc_html__( 'Three', 'klippe-twitter-feed' ) => '3',
								esc_html__( 'Four', 'klippe-twitter-feed' )  => '4',
								esc_html__( 'Five', 'klippe-twitter-feed' )  => '5'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Space Between Columns', 'klippe-twitter-feed' ),
							'value'      => array_flip( klippe_mikado_get_space_between_items_array() )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'number_of_tweets',
							'heading'    => esc_html__( 'Number of Tweets', 'klippe-twitter-feed' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'transient_time',
							'heading'    => esc_html__( 'Tweets Cache Time', 'klippe-twitter-feed' )
						)
					)
				)
			);
