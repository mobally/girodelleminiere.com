...
if ( ! function_exists( 'klippe_mikado_admin_map_init' ) ) {
	function klippe_mikado_admin_map_init() {
		do_action( 'klippe_mikado_before_options_map' );
		...
		do_action( 'klippe_mikado_options_map' );
		
		do_action( 'klippe_mikado_after_options_map' );
	}
	
	add_action( 'after_setup_theme', 'klippe_mikado_admin_map_init', 1 );
}