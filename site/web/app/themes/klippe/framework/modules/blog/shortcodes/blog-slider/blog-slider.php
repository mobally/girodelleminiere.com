...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Mikado Blog Slider', 'klippe' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'klippe' )            => 'slider',
							esc_html__( 'Carousel', 'klippe' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'klippe' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		klippe_mikado_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
