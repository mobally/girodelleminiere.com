...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Mikado Blog List', 'klippe' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'klippe' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'klippe' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'klippe' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'klippe' ),
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'klippe' ) => 'thumbnail',
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'klippe' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'klippe' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'klippe' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'klippe' ),
						'value'      => array_flip( klippe_mikado_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'klippe' ),
						'value'      => array_flip( klippe_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'klippe' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'klippe' ),
						'value'      => array_flip( klippe_mikado_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'klippe' ),
						'value'      => array_flip( klippe_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'klippe' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'klippe' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'klippe' ),
						'value'      => array_flip( klippe_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'klippe' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'klippe' ),
						'value'      => array_flip( klippe_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'klippe' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'post_info_read',
						'heading'    => esc_html__( 'Enable Read More', 'klippe' ),
						'value'      => array_flip( klippe_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'klippe' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'klippe' ),
						'value'      => array(
							esc_html__( 'None', 'klippe' )            => 'no-pagination',
							esc_html__( 'Standard', 'klippe' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'klippe' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'klippe' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'klippe' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		klippe_mikado_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'klippe' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'klippe' ) . ': ' . $category_title;
				}
