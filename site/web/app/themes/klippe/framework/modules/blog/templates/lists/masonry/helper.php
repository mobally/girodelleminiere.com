...
if ( ! function_exists( 'klippe_mikado_get_blog_holder_params' ) ) {
	...
	function klippe_mikado_get_blog_holder_params( $params ) {
		...
		$masonry_layout = klippe_mikado_get_meta_field_intersect( 'blog_masonry_layout' );
...
if ( ! function_exists( 'klippe_mikado_get_blog_list_classes' ) ) {
	/**
	 * Function that generates blog list holder classes for blog list templates
	 */
	function klippe_mikado_get_blog_list_classes( $classes ) {
		$list_classes   = array();
		$list_classes[] = 'mkdf-blog-type-masonry';
		
		$number_of_columns = klippe_mikado_get_meta_field_intersect( 'blog_masonry_number_of_columns' );
		if ( ! empty( $number_of_columns ) ) {
			$list_classes[] = 'mkdf-blog-' . $number_of_columns . '-columns';
		}
		
		$space_between_items = klippe_mikado_get_meta_field_intersect( 'blog_masonry_space_between_items' );
	...
	add_filter( 'klippe_mikado_blog_list_classes', 'klippe_mikado_get_blog_list_classes' );
}
