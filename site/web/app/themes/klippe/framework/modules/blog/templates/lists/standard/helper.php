...
if ( ! function_exists( 'klippe_mikado_get_blog_holder_classes' ) ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function klippe_mikado_get_blog_holder_classes( $classes ) {
	...
	add_filter( 'klippe_mikado_blog_holder_classes', 'klippe_mikado_get_blog_holder_classes' );
}
