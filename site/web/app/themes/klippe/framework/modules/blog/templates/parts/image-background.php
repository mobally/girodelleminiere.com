...
$blog_list_image_id = ! empty( $image_meta ) && klippe_mikado_blog_item_has_link() ? klippe_mikado_get_attachment_id_from_url( $image_meta ) : '';
$background_image   = '';
...
?>
<?php if ( $has_featured ) { ?>
	<div class="mkdf-post-image-background" <?php klippe_mikado_inline_style($background_image); ?>>
