...
if ( ! function_exists( 'klippe_mikado_map_content_bottom_meta' ) ) {
	function klippe_mikado_map_content_bottom_meta() {
		
		$content_bottom_meta_box = klippe_mikado_add_meta_box(
			array(
				'scope' => apply_filters( 'klippe_mikado_set_scope_for_meta_boxes', array( 'page', 'post' ), 'content_bottom_meta' ),
				'title' => esc_html__( 'Content Bottom', 'klippe' ),
		...
		$show_content_bottom_meta_container = klippe_mikado_add_admin_container(
			array(
				'parent'          => $content_bottom_meta_box,
		...
		klippe_mikado_add_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Choose a content bottom sidebar to display', 'klippe' ),
	...
	add_action( 'klippe_mikado_meta_boxes_map', 'klippe_mikado_map_content_bottom_meta', 71 );
}