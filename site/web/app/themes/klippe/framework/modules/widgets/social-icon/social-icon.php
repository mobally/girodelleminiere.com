...
class KlippeMikadoSocialIconWidget extends KlippeMikadoWidget {
	
	public function __construct() {
		parent::__construct(
			'mkdf_social_icon_widget',
			esc_html__( 'Mikado Social Icon Widget', 'klippe' ),
			array( 'description' => esc_html__( 'Add social network icons to widget areas', 'klippe' ) )
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			klippe_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'  => 'textfield',
					'name'  => 'link',
	...
	public function widget( $args, $instance ) {
		...
		<a class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" <?php echo klippe_mikado_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php klippe_mikado_inline_style( $icon_styles ) ?> href="<?php echo esc_url( $link ); ?>" target="<?php echo esc_attr( $target ); ?>">
