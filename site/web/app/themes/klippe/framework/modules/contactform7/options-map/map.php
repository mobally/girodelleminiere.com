...
if ( ! function_exists('klippe_mikado_contact_form_7_options_map') ) {

	function klippe_mikado_contact_form_7_options_map() {
		
		klippe_mikado_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'klippe' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = klippe_mikado_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'klippe' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = klippe_mikado_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'klippe' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'klippe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = klippe_mikado_add_admin_row(
			array(
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'klippe' ),
			)
		);
		...
		$typography_text_row2 = klippe_mikado_add_admin_row(
			array(
		...
		$typography_text_row3 = klippe_mikado_add_admin_row(
			array(
		...
		$typography_label_group = klippe_mikado_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'klippe' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'klippe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = klippe_mikado_add_admin_row(
			array(
		...
		$typography_label_row2 = klippe_mikado_add_admin_row(
			array(
		...
		$background_border_group = klippe_mikado_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'klippe' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'klippe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = klippe_mikado_add_admin_row(
			array(
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'klippe' )
			)
		);
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'klippe' )
			)
		);
		
		$background_border_row2 = klippe_mikado_add_admin_row(
			array(
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'klippe' ),
			)
		);
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'klippe' )
			)
		);
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'klippe' )
			)
		);
		
		$background_border_row3 = klippe_mikado_add_admin_row(
			array(
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'klippe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'klippe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = klippe_mikado_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'klippe' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = klippe_mikado_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'klippe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'klippe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'klippe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'klippe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = klippe_mikado_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'klippe' ),
				'description' => esc_html__( 'Setup form elements margin', 'klippe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = klippe_mikado_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'klippe' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'klippe' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = klippe_mikado_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'klippe' ),
				'description' => esc_html__( 'Setup button text typography', 'klippe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = klippe_mikado_add_admin_row(
			array(
		...
		$button_typography_row2 = klippe_mikado_add_admin_row(
			array(
		...
		$button_background_border_group = klippe_mikado_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'klippe' ),
				'description' => esc_html__( 'Setup button background and border style', 'klippe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = klippe_mikado_add_admin_row(
			array(
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'klippe' )
			)
		);
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'klippe' )
			)
		);
		
		$button_background_border_row2 = klippe_mikado_add_admin_row(
			array(
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'klippe' )
			)
		);
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'klippe' )
			)
		);
		
		$button_background_border_row3 = klippe_mikado_add_admin_row(
			array(
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'klippe' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'klippe' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = klippe_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'klippe')
		));

		//Text Typography

		$typography_text_group = klippe_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'klippe'),
			'description'	=> esc_html__('Setup typography for form elements text', 'klippe'),
		...
		$typography_text_row1 = klippe_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = klippe_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = klippe_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = klippe_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'klippe'),
			'description'	=> esc_html__('Setup typography for form elements label', 'klippe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = klippe_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = klippe_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = klippe_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'klippe'),
			'description'	=> esc_html__('Setup form elements background and border style', 'klippe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = klippe_mikado_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = klippe_mikado_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = klippe_mikado_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = klippe_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'klippe'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = klippe_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = klippe_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'klippe'),
			'description'	=> esc_html__('Setup form elements margin', 'klippe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = klippe_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = klippe_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'klippe'),
			'description'	=> esc_html__('Setup button text typography', 'klippe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = klippe_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = klippe_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = klippe_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'klippe'),
			'description'	=> esc_html__('Setup button background and border style', 'klippe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = klippe_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = klippe_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = klippe_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = klippe_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'klippe')
        ));
        ...
        $typography_label_row3 = klippe_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = klippe_mikado_add_admin_row(array(
	...
	add_action( 'klippe_mikado_options_map', 'klippe_mikado_contact_form_7_options_map', 20);
}