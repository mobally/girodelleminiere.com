...
if ( ! function_exists( 'klippe_mikado_get_title_types_options' ) ) {
	function klippe_mikado_get_title_types_options() {
		$title_type_options = apply_filters( 'klippe_mikado_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'klippe_mikado_get_title_type_default_options' ) ) {
	function klippe_mikado_get_title_type_default_options() {
		$title_type_option = apply_filters( 'klippe_mikado_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('klippe_mikado_title_options_map') ) {
	function klippe_mikado_title_options_map() {
		$title_type_options        = klippe_mikado_get_title_types_options();
		$title_type_default_option = klippe_mikado_get_title_type_default_options();
		...
		$panel_title = klippe_mikado_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'klippe')
			)
		);
		...
		klippe_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'klippe' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = klippe_mikado_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				klippe_mikado_add_admin_field(
					...
					klippe_mikado_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'klippe' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'klippe_mikado_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = klippe_mikado_add_admin_panel(
			array(
				'page'  => '_title_page',
				'name'  => 'panel_title_typography',
				'title' => esc_html__( 'Typography', 'klippe' )
			)
		);
			...
			$group_page_title_styles = klippe_mikado_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'klippe' ),
					'description' => esc_html__( 'Define styles for page title', 'klippe' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = klippe_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = klippe_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = klippe_mikado_add_admin_row(
					array(
			...
			klippe_mikado_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'klippe' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = klippe_mikado_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'klippe' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'klippe' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = klippe_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = klippe_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = klippe_mikado_add_admin_row(
					array(
		...
		do_action( 'klippe_mikado_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'klippe_mikado_options_map', 'klippe_mikado_title_options_map', 6);
}