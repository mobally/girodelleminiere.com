...
if ( ! function_exists( 'klippe_mikado_get_search' ) ) {
	...
	add_action( 'klippe_mikado_before_page_header_html_close', 'klippe_mikado_get_search' );
	add_action( 'klippe_mikado_before_mobile_header_html_close', 'klippe_mikado_get_search' );
}
...
if ( ! function_exists( 'klippe_mikado_load_search_template' ) ) {
	...
	function klippe_mikado_load_search_template() {
        ...
        klippe_mikado_get_module_template_part( 'types/slide-from-header-bottom/templates/slide-from-header-bottom', 'search', '', $parameters );
	}
}