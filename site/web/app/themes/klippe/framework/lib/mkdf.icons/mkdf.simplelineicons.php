...
class KlippeMikadoSimpleLineIcons implements iKlippeMikadoIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'klippe'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'klippe'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'klippe'),
            'icon-social-facebook'    => esc_html__('Facebook', 'klippe'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'klippe'),
            'icon-social-github'      => esc_html__('Github', 'klippe'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'klippe'),
            'icon-social-instagram'   => esc_html__('Instagram', 'klippe'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'klippe'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'klippe'),
            'icon-social-reddit'      => esc_html__('Reddit', 'klippe'),
            'icon-social-skype'       => esc_html__('Skype', 'klippe'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'klippe'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'klippe'),
            'icon-social-spotify'     => esc_html__('Spotify', 'klippe'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'klippe'),
            'icon-social-twitter'     => esc_html__('Twitter', 'klippe'),
            'icon-social-youtube'     => esc_html__('Youtube', 'klippe')
        );
    }
