...
/*
   Class: KlippeMikadoDashboardForm
   A class that initializes Mikado Dashboard Container
*/
class KlippeMikadoDashboardForm implements iKlippeMikadoLayoutNode, iKlippeMikadoRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: KlippeMikadoDashboardGroup
   A class that initializes KlippeMikado Group Field
*/
class KlippeMikadoDashboardGroup implements iKlippeMikadoLayoutNode, iKlippeMikadoRender{
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: KlippeMikadoDashboardTitle
   A class that initializes Dashboard Title
*/
class KlippeMikadoDashboardTitle implements iKlippeMikadoRender {
	private $name;
	private $title;
...
/*
   Class: KlippeMikadoDashboardField
   A class that initializes KlippeMikado Front Field
*/

class KlippeMikadoDashboardField implements iKlippeMikadoRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class KlippeMikadoDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class KlippeMikadoDashboardFieldText extends KlippeMikadoDashboardFieldType {
...
class KlippeMikadoDashboardFieldTextArea extends KlippeMikadoDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class KlippeMikadoDashboardFieldImage extends KlippeMikadoDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
        ...
        if(isset($args['not_image']) && $args['not_image'] == true) {
        	...
        	$value_html = '<li class="mkdf-dashborad-gallery-image"><img src="'.esc_url($value).'" /></li>';
	    }
			...
			<div class="mkdf-dashboard-gallery-holder">
				...
				<div class="mkdf-dashboard-gallery-uploader">
					...
					if ( mkdf_membership_theme_installed() ) {
						echo klippe_mikado_get_button_html( array(
							'text'      => esc_html__( 'Upload', 'klippe' ),
							'custom_class' => 'mkdf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" target="_self" class="mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-dashboard-gallery-upload"><span class="mkdf-btn-text">' . esc_html__( 'Upload', 'klippe' ) . '</span></a>';
					} ?>
					...
					<?php if ($value !== '' && $value !== false) { ?>
						<button class="mkdf-btn mkdf-btn-solid mkdf-dashboard-remove-image"><?php esc_html_e('Remove Media','klippe'); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class KlippeMikadoDashboardFieldGallery extends KlippeMikadoDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class KlippeMikadoDashboardFieldSelect extends KlippeMikadoDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class KlippeMikadoDashboardFieldDate extends KlippeMikadoFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class KlippeMikadoDashboardFieldIcon extends KlippeMikadoDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = \KlippeMikadoIconCollections::get_instance()->getIconCollectionsEmpty();
		$icons_collections = \KlippeMikadoIconCollections::get_instance()->getIconCollectionsKeys();
				...
				<div class="mkdf-dashboard-item">
					...
					<div class="mkdf-dashboard-icon-holder">
						...
						<?php foreach ( $icons_collections as $icons_collection ) {
							$icons_param = \KlippeMikadoIconCollections::get_instance()->getIconCollectionParamNameByKey( $icons_collection );
	                        $style       = 'display: none';
							...
							<div class="mkdf-icon-collection-holder" style="<?php echo esc_attr( $style ); ?>" data-icon-collection="<?php echo esc_attr( $icons_collection ); ?>">
                                <select name="<?php echo esc_attr( $name . '[' . $icons_param . ']'); ?>" id="<?php echo esc_attr( $name . '[' . $icons_param . ']'); ?>">
									<?php
									$icons = \KlippeMikadoIconCollections::get_instance()->getIconCollection( $icons_collection );
...
class KlippeMikadoDashboardFieldColor extends KlippeMikadoDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class KlippeMikadoDashboardFieldCheckBoxGroup extends KlippeMikadoDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class KlippeMikadoDashboardFieldAddress extends KlippeMikadoFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
			...
			<div class="mkdf-dashboard-field-row">
				<div class="mkdf-dashboard-item col-lg-<?php echo esc_attr($col_width); ?>">
					<div class="mkdf-dashboard-input-holder">
						...
						<a id="reset" href="#" style="display:none;"><?php esc_html_e( 'Reset Marker', 'klippe' ); ?></a>
					</div>
				</div>
			</div>
		</div>
...
class KlippeMikadoDashboardRepeater implements iKlippeMikadoRender {
	private $label;
	private $description;
	private $name;
	private $fields;
	...
	function __construct( $fields, $name, $label = '', $description = '', $button_text = '', $table_layout = false, $value = array() ) {
		...
		$this->name        = $name;
		$this->num_of_rows = 1;
		$this->button_text = ! empty( $button_text ) ? $button_text : esc_html__( 'Add New Item', 'klippe' );
			...
			<?php if ($this->table_layout) { ?>
				<div class="mkdf-dashboard-repeater-table-heading">
					<div class="mkdf-dashboard-repeater-fields-holder">
						<div class="mkdf-dashboard-repeater-table-cell mkdf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'klippe' ) ?></div>
						...
						<div class="mkdf-dashboard-repeater-table-cell mkdf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'klippe' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class KlippeMikadoDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array()) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new KlippeMikadoDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'textarea':
				$field = new KlippeMikadoDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'date':
				$field = new KlippeMikadoDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new KlippeMikadoDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'gallery':
				$field = new KlippeMikadoDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new KlippeMikadoDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new KlippeMikadoDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new KlippeMikadoDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'checkboxgroup':
				$field = new KlippeMikadoDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'address':
				$field = new KlippeMikadoDashboardFieldAddress();
