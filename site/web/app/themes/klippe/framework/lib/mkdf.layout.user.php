...
/*
   Class: KlippeMikadoUserField
   A class that initializes KlippeMikado User Field
*/

class KlippeMikadoUserField implements iKlippeMikadoRender {
	private $type;
	private $name;
	private $label;
	private $description;
	...
	function __construct( $type, $name, $label = "", $description = "", $options = array(), $args = array() ) {
		...
		$this->args        = $args;
		add_filter( 'klippe_mikado_user_fields', array( $this, 'addFieldForEditSave' ) );
	}
...
abstract class KlippeMikadoUserFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array() );
}

class KlippeMikadoUserFieldText extends KlippeMikadoUserFieldType {
...
class KlippeMikadoUserFieldSelect extends KlippeMikadoTaxonomyFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array() ) {
...
/*
   Class: KlippeMikadoUserGroup
   A class that initializes Mikado User Group
*/
class KlippeMikadoUserGroup implements iKlippeMikadoLayoutNode, iKlippeMikadoRender {
	public $children;
	public $title;
	public $description;
...
class KlippeMikadoUserFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $hidden = false ) {

		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new KlippeMikadoUserFieldText();
				$field->render( $name, $label, $description, $options, $args, $hidden );
				break;
			case 'select':
				$field = new KlippeMikadoUserFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $hidden );
				break;
			default:
				break;
