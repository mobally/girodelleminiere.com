...
$row_content_width = $anchor = $content_text_aligment = $simple_background_color = $simple_background_image = $disable_background_image = $parallax_background_image = $parallax_bg_speed = $parallax_bg_height = $row_background_shadow = '';
...
if ( $row_background_shadow === 'yes' ) {
    $css_classes[] = 'mkdf-row-with-shadow';
}
...
if($row_content_width === 'grid'){
	$mkdf_row_wrapper_start .= '<div class="mkdf-row-grid-section-wrapper '.esc_attr($grid_row_classes).'" '.esc_attr($grid_row_datas).' ' . klippe_mikado_get_inline_style( $mkdf_grid_row_styles ) . '><div class="mkdf-row-grid-section">';
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . klippe_mikado_get_inline_style( $mkdf_vc_row_styles ) . '>';
